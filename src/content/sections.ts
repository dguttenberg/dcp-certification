      ...
      },
      {
        ...
        tools: [
          ...
          },
          {
            ...
            detail: 'Access is managed and licensed individually because it carries more capability and more responsibility. Runway operates under a Stagwell-level master service agreement with full indemnification and data protection. New: Runway now provides indemnification for its partner models in addition to its core model — meaning the third-party models available inside Runway are covered too.',
          ...
          },
          {
            ...
            detail: 'Built by Anthropic, Claude Code is the tool of choice for people at DCP who want to go beyond standard productivity — people building with AI in addition to just using it. Better suited for complex reasoning, longer documents, research synthesis, and building AI-powered workflows. This certification course was built using Claude Code — a concrete example of what the tool can do beyond just answering questions. If you\'re starting to use AI to build things, not just ask questions, Claude Code is likely the tool you\'ll grow into. Access is managed.',
            access: 'Managed access',
          },
          {
            name: 'Figma',
