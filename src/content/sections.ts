    ...
    cards: [
        ...
        tools: [
          {
            ...
            detail: 'Trained on licensed and public domain content specifically to make it commercially safe — Adobe built it that way because their customers are professional creators who can\'t afford IP exposure.\n\nIncludes a full suite: train custom models to recreate a specific style or subject, plus Firefly Boards, a collaborative space to explore and iterate with Firefly and other AI models.\n\nIndemnification covers outputs from Firefly\'s native models. It does not automatically extend to third-party models available inside Firefly.\n\nHow to get access: included with your Creative Cloud subscription. If you need it provisioned, contact IT.',
            access: 'Everyone',
          },
          {
            ...
            detail: 'Lives inside the tools most of the agency already uses — documents, email, communication. Our enterprise agreement protects your inputs.\n\nEnterprise subscriptions now include Claude and ChatGPT as selectable options alongside Copilot\'s core model, so you can match the model to the task without leaving the tool.\n\nPrimarily for text and productivity: summarizing, drafting, researching, organizing. The broadest-access tool we have, appropriate for most day-to-day AI-assisted work.\n\nHow to get access: already enabled on your Doner Microsoft 365 account. If it isn\'t showing up, contact IT.',
            access: 'Everyone',
          },
          {
            name: 'Runway',
            ...
            detail: 'Managed and licensed individually because it carries more capability and more responsibility. Operates under a Stagwell-level master service agreement with full indemnification and data protection.\n\nNew: Runway now provides indemnification for its partner models in addition to its core model — meaning the third-party models available inside Runway are covered too.\n\nHow to get access: once you\'ve passed this certification, request a seat through your producer or department lead. They\'ll route the request to the team managing licenses.',
            access: 'Managed access',
          },
          {
            name: 'Claude Code',
            icon: '💬',
            summary: 'For people building with AI, not just using it.',
            detail: 'Built by Anthropic. The tool of choice for people at DCP who want to go beyond standard productivity — building with AI, not just using it.\n\nBetter suited for complex reasoning, longer documents, research synthesis, and AI-powered workflows. This certification course was built using Claude Code — a concrete example of what it can do.\n\nIf you\'re starting to use AI to build things, this is likely the tool you\'ll grow into.\n\nHow to get access: once you\'ve passed this certification, request a seat through your producer or department lead.',
            access: 'Managed access',
          },
          {
            name: 'Figma',
            ...
            detail: 'AI features inside Figma can generate layouts, suggest components, auto-annotate designs, and assist with copy — all in the environment designers already work in.\n\nUsing AI inside an enterprise tool you already have is different from finding a standalone AI design tool. The protections travel with the platform.\n\nHow to get access: if you have a Figma seat, AI features are already on. New seats are requested through your producer or department lead.',
            access: 'Managed access',
          },
          {
            name: 'Stagwell ID Graph',
            icon: '🔗',
            summary: 'Stagwell\'s privacy-safe audience intelligence platform.',
            detail: 'A targeting and audience-intelligence layer used by media and strategy teams to help campaigns reach the right people. It connects signals like devices, behaviors, and interest categories — not personal names or identities — to build privacy-safe audience profiles.\n\nIn practice: it\'s how a campaign moves from "someone visited this site" to "this type of person is likely interested in this category." It does not give us, or anyone using it, access to individual personal data.\n\nIt was built in partnership with Palantir, who provides the underlying data infrastructure. Stagwell controls the data governance, the privacy framework, and how the platform is used. For most people at DCP it powers the work rather than being something you log into directly.\n\nHow to get access: it\'s used at the platform level by specific media and strategy teams. If your work would benefit from it, your department lead can advise.',
          ...
          },
          {
            ...
            detail: 'Designed to connect AI capabilities across the network\'s agencies into a shared orchestration layer.\n\nEarly stage, and not something most people at DCP will interact with directly right now. Worth knowing it exists — it\'s where the network is heading, and DCP\'s AI infrastructure is designed to connect into it over time.\n\nHow to get access: not yet broadly available. Your department lead will share more as access opens up.',
            access: 'Network-level',
          },
        ],
        callout: {
          text: 'Yes, this certification was built with Claude Code. We practice what we preach.',
          style: 'tip',
        },
      },
      {
      ...
      },
      {
        ...
        points: [
          ...
          'Each approved tool has specific strengths: Copilot for productivity, Firefly for images, Runway for video, Claude Code for building with AI.',
...

  {
    ...
    cards: [
      ...
      },
      {
        id: 's4-text-5',
        type: 'text',
        heading: 'The exception that still applies: Personally Identifiable Information (PII)',
        body: 'Even in approved tools, personally identifiable information (PII) requires care. PII is anything that identifies a specific real person — names, contact details, health data, employee IDs. Strip it before processing.\n\nThis isn\'t about the tool\'s security. It\'s about data-handling principles that exist independent of any platform. Anonymize first, then use the approved tool with the rest of the data intact.',
      },
      {
        id: 's4-text-6',
        type: 'text',
        ...
        callout: {
          text: 'A Google image search is not a source. You cannot use one as an input or a reference — even for inspiration, even just to "see what it looks like." If you don\'t hold rights to the asset, it doesn\'t go in.',
          style: 'warning',
        },
      },
      {
